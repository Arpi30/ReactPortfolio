...
import { Stars } from "./styledComponents/style";
                ...
                {starIcon.map((item, index) => {
                  return (
                    <AiOutlineStar
                      ...
                      key={index}
                      cursor="pointer"
                      onClick={() => starsClick(index + 1, setStarWeatherVal)}
                      color={
                ...
                {starIcon.map((item, index) => {
                  return (
                    <AiOutlineStar
                      ...
                      color={
                        (todoHover || startTodoVal) > index ? "#e8e819" : "grey"
                      }
                      onMouseOver={() =>
                ...
                {starIcon.map((item, index) => {
                  return (
                    <AiOutlineStar
                      ...
                      key={index}
                      cursor="pointer"
                      onClick={() => starsClick(index + 1, setStartMoovieVal)}
                      color={
